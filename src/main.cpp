...
int main() {
    ...
    std::cout << "Naive CSR matmul time: " << naiveTime.count() << " seconds" << std::endl;
    std::cout << "Naive result nnz: " << naiveResult.getCoords().size() << std::endl;
    ...
    std::cout << "Optimized CSR matmul time: " << optimizedTime.count() << " seconds" << std::endl;
    std::cout << "Optimized result nnz: " << optimizedResult.getCoords().size() << std::endl;

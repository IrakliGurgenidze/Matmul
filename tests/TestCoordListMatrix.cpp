...
TEST_CASE("CoordListMatrix naive matmul dimensions match",
          "[CoordListMatrix]") {
 ...
 */
TEST_CASE("CoordListMatrix matmul Trec4(2×3) vs Trec5(3×7)",
          "[CoordListMatrix]") {
...
TEST_CASE("CoordListMatrix batchedNaiveMatmul works correctly",
          "[CoordListMatrix][batch]") {

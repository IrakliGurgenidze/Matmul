...
TEST_CASE("File-based optimized matmul estimate vs ground truth",
          "[CoordListMatrix][Estimator][Integration]") {
  const std::string mtxFileA =
      "/Users/griffinravo/CLionProjects/Matmul/data/bwm200.mtx";
  const std::string mtxFileB =
      "/Users/griffinravo/CLionProjects/Matmul/data/rdb200.mtx";
